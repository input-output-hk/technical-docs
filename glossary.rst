...
.. list-table:: Cardano Glossary
   ...
   * - node
     - the core component that is used to participate in the Cardano blockchain. A node runs the software that implements the Ouroboros protocol underlying Cardano and it validates tasks related to networking, transactions, and blocks.
   * - Ouroboros
   ...
   * - pledging
     - the process by which stake pool owners pledge some, or all, of your ada to the pool, to make it more attractive to people that want to delegate. The higher the amount of ada that is pledged, the higher the rewards that will be paid out to members of the pool.
   * - produced blocks
